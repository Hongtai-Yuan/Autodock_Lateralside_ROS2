    ...
    class autodock_controller :public rclcpp::Node{
        public:
            autodock_controller():Node("autodock_controller"){
                this->declare_parameter<double>("cmd_vel_angular_rate", 0.22);
                ...
                this->declare_parameter<double>("approach_angle" , 0.05);
                this->get_parameter("approach_angle" , approach_angle );
                this->declare_parameter<int>("lost_tag_max" ,1);
                ...
                this->declare_parameter<int>("max_center_count", 1);
        ...
        private:
            ...
            double cmd_vel_angular_rate, cmd_vel_linear_rate, approach_angle, default_turn, 
                    final_approach_distance, jog_distance, finish_distance, blind_angle, blind_sign = 1.0;
            struct tag_pose{
                double theta;
                double distance ;
                double theta_bounds;
